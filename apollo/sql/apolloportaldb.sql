...
INSERT INTO `AppNamespace` (`Name`, `AppId`, `Format`, `IsPublic`, `Comment`)
VALUES 
  ('data.yaml', 'CloudMiddleware', 'yaml', 0, '');
INSERT INTO `AppNamespace` (`Name`, `AppId`, `Format`, `IsPublic`, `Comment`)
VALUES 
  ('data.yaml', 'secco_user_center', 'yaml', 0, '');
...
VALUES
  ...
  (6, 'AssignRole', 'CloudMiddleware'),
  (7, 'CreateNamespace', 'CloudMiddleware'),
  (8, 'CreateCluster', 'CloudMiddleware'),
  (9, 'ManageAppMaster', 'CloudMiddleware'),
  (10, 'ModifyNamespace', 'CloudMiddleware+application'),
  (11, 'ReleaseNamespace', 'CloudMiddleware+application'),
  (12, 'ModifyNamespace', 'CloudMiddleware+data.yaml'),
  (13, 'ReleaseNamespace', 'CloudMiddleware+data.yaml'),
  (14, 'AssignRole', 'secco_user_center'),
  (15, 'CreateNamespace', 'secco_user_center'),
  (16, 'CreateCluster', 'secco_user_center'),
  (17, 'ManageAppMaster', 'secco_user_center'),
  (18, 'ModifyNamespace', 'secco_user_center+data.yaml'),
  (19, 'ReleaseNamespace', 'secco_user_center+data.yaml'),
  (20, 'ModifyNamespace', 'secco_user_center+data.yaml+DEV'),
  (21, 'ReleaseNamespace', 'secco_user_center+data.yaml+DEV');
...
VALUES
  ...
  (4, 'Master+CloudMiddleware'),
  (5, 'ModifyNamespace+CloudMiddleware+application'),
  (6, 'ReleaseNamespace+CloudMiddleware+application'),
  (7, 'ModifyNamespace+CloudMiddleware+data.yaml'),
  (8, 'ReleaseNamespace+CloudMiddleware+data.yaml'),
  (9, 'Master+secco_user_center'),
  (10, 'ManageAppMaster+secco_user_center'),
  (11, 'ModifyNamespace+secco_user_center+data.yaml'),
  (12, 'ReleaseNamespace+secco_user_center+data.yaml'),
  (13, 'ModifyNamespace+secco_user_center+data.yaml+DEV'),
  (14, 'ReleaseNamespace+secco_user_center+data.yaml+DEV');
